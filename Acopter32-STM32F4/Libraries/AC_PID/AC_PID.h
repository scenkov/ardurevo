...
public:
	...
	float get_d_f(float error, float dt);
	float get_pid_f(float error, float dt);
...
private:
	...
	///
	static const float _filter = 15.9155e-3; // Set to  "1 / ( 2 * PI * f_cut )";
