...
{
    return strcasecmp(str1, (const prog_char *)pstr);
}

static inline int strcmp_P(const char *str1, const prog_char_t *pstr)
{
    return strcmp(str1, (const prog_char *)pstr);
}

static inline int strncmp_P(const char *str1, const prog_char_t *pstr, size_t n)
{
	//return strcmp(str1, (const prog_char *)pstr);
	return strncmp(str1, (const prog_char *)pstr, n);
}

static inline size_t strlen_P(const prog_char_t *pstr)
{
    return strlen((const prog_char *)pstr);
}

static inline size_t strnlen_P(const prog_char_t *pstr, size_t n)
{
    return strnlen((const prog_char *)pstr, n);
}

static inline void *memcpy_P(void *dest, const prog_char_t *src, size_t n)
{
    return memcpy(dest, (const prog_char *)src, n);
}
...
{
    return strncpy(buffer, (const prog_char *)pstr, buffer_size);
}
