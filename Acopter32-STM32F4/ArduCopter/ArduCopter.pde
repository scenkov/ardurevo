...
#elif CONFIG_COMPASS == HAL_COMPASS_HMC5843_EXT
...
#elif CONFIG_INS_TYPE == HAL_INS_MPU6000_EXT
AP_InertialSensor_MPU6000_Ext ins;
#elif CONFIG_INS_TYPE == HAL_INS_PX4
AP_InertialSensor_PX4 ins;
#elif CONFIG_INS_TYPE == HAL_INS_VRBRAIN
AP_InertialSensor_VRBRAIN ins;
#elif CONFIG_INS_TYPE == HAL_INS_REVOMINI
AP_InertialSensor_REVOMINI ins;
...
static MOTOR_CLASS motors(g.rc_1, g.rc_2, g.rc_3, g.rc_4, g.rc_7, g.rc_8, g.heli_servo_1, g.heli_servo_2, g.heli_servo_3, g.heli_servo_4);
    ...
    static MOTOR_CLASS motors(g.rc_1, g.rc_2, g.rc_3, g.rc_4, g.rc_6);
#else
