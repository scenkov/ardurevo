...
#define AP_RANGEFINDER_MAXSONARXL_SCALER (1.0/4.0)
   #else
...
#define AP_RANGEFINDER_MAXSONARLV 1
   #if CONFIG_HAL_BOARD == HAL_BOARD_VRBRAIN
#define AP_RANGEFINDER_MAXSONARLV_SCALER ((2.54/2.0)/4.0)
   #else
...
#define AP_RANGEFINDER_MAXSONARXLL 2
   #if CONFIG_HAL_BOARD == HAL_BOARD_VRBRAIN
#define AP_RANGEFINDER_MAXSONARXLL_SCALER (2.0/4.0)
   #else
...
#define AP_RANGEFINDER_MAXSONARHRLV 3
   #if CONFIG_HAL_BOARD == HAL_BOARD_VRBRAIN
#define AP_RANGEFINDER_MAXSONARHRLV_SCALER (0.512/4.0)
   #else
