...
void VRBRAINAnalogIn::_register_channel(VRBRAINAnalogSource* ch) {
    if (_num_channels >= VRBRAIN_INPUT_MAX_CHANNELS) {
        for(;;) {
            hal.console->print_P(PSTR(
                "Error: AP_HAL_VRBRAIN::VRBRAINAnalogIn out of channels\r\n"));
