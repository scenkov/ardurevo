...
#ifndef __AP_INERTIAL_SENSOR_REVOMINI_H__
#define __AP_INERTIAL_SENSOR_REVOMINI_H__
...
class AP_InertialSensor_REVOMINI : public AP_InertialSensor
{
public:

    AP_InertialSensor_REVOMINI();
...
#endif // __AP_INERTIAL_SENSOR_REVOMINI_H__
