...
void EEPROMClass::eeprom_write_block (const void *pointer_ram, void *pointer_eeprom, size_t n)
{
	...
	uint32_t ret = sEE_WriteBuffer(buff,addr16,numbytes);
	if(ret == 1){
