...
HardwareSPI *AP_ADC_ADS7844::_SPIx;
uint8_t AP_ADC_ADS7844::_cs_pin;
...
bool AP_ADC_ADS7844::automaticRead()
{
	if (_scheduler)
		return true;
	return false;
...
// Constructors ////////////////////////////////////////////////////////////////
AP_ADC_ADS7844::AP_ADC_ADS7844(uint8_t cs_pin, HardwareSPI *spi_dev)
{
    _scheduler = NULL;
	_cs_pin = cs_pin;
	_SPIx = spi_dev;
...
void AP_ADC_ADS7844::Init( AP_PeriodicProcess * scheduler )
{
    ...
    if (_scheduler)
        _scheduler->register_process( AP_ADC_ADS7844::read );
